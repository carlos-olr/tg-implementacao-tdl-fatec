...
import model.core.others.Pilha;
...
public class PilhaFailTest {
	...
	public void garantirAdicionarItemNaPilha() {
		...
		Long l1 = new Long(1);
		p1.adicionarItem(l1);
		Assert.assertEquals(l1, p1.getItens().get(p1.getItens().size() - 1));
	}
	...
	public void garantirUltimoItemAddUltimoNaPilha() {
		...
		p1.adicionarItem(l2);
		p1.adicionarItem(l3);
		Assert.assertEquals(l3, p1.getItens().get(p1.getItens().size() - 1));
	}
